...
% [x,v] = randfixedsum(n,m,s,a,b) returns a vector or matrix of random
% numbers attending a chosen restriction at the their sum.
% 
% On entry
% n - number of rows
% m - number of columns
% s - restriction - sum of the elements (column) to be imposed
% [a,b] - chosen interval
%
% Example
%
...
% Modified by Eduardo Mendes - Set 16, 2017

if ((nargin < 2) || (nargin > 5)) 
    error('Randomfixedsum requires 2 or 5 input arguments.');
elseif nargin == 2
    s=1; % sum equals to 1
    a=0;
    b=1; % Interval [0,1]
...
% There is a problem if a row vector is chosen os I had to trick the
% algorithm
