...
A matlab code is provided that uses Yalmip with sedumi or mosek. It is assumed that al the necessary packages are already installed in the MATLAB environment. If not you can uncomment a few lines in the main script after chaning them accordingly.
...
The sdpvar vesion of the same LMI can be found in the variable m21 which is a cell array. LMI 21 is piled up in the variable called biglmi21.
