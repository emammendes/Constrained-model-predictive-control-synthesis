...
As anternative, I have modified the main script to *script_generate_feasible_region_brute_force.m* to plot the feasible region.  Below you will find another example of a feasible region but this time vector B (control) is *B_{2,1}=[0.4;1]*.
